        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <center>
        <a href="{{ route('form.create') }}" class="fa fa-plus-square btn btn-primary btn-rounded btn-floating ">
            Tambah Data
        </a>
    </center>
            </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                    @foreach($a as $key)
                    <img src="{!!asset('/assets/img/fotobarang/'.$key.'')!!}" width="70" height="70">
                    @endforeach
                    </td>        
                    <td>
                        <form method="post" action="{{ route('form.destroy',$data->id) }}">
                        <a href="{{ route('form.edit',$data->id) }}" class="btn btn-warning ">Edit</a>
