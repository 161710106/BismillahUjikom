        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <center>
        <a href="{{ route('galeris.create') }}" class="fa fa-plus-square btn btn-primary btn-rounded btn-floating ">
            Tambah Data
        </a>
    </center>
            </div>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('galeris.edit',$data->id) }}" class="btn btn-warning ">Edit</a>
