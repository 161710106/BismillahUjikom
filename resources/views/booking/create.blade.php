...
<div class="col-xs-12">
          <div class="box">
            ...
            <center><h3 class="box-title">Tambah Data Bookings</h3></center>
            ...
            <div class="form-group {{ $errors->has('kategori_id') ? ' has-error' : '' }}">
				...
				<input type="number" value=""  name="harga" class="form-control" 
                onchange="document.SimpleCalc1.circumference.value  = CalcCircumference(this.value);" required>
				@if ($errors->has('harga'))
				...
				<input type="number" value=""  name="sisa" class="form-control" 
                onchange="document.SimpleCalc1.circumference.value  = CalcCircumference(this.value);" required>
				@if ($errors->has('sisa'))
